...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public int DisplayGetInventoryObjectToPutDown()
        {
            ...
            if (_gameUniverse.TravelerInventory().Count > 0)
            {
                DisplayGamePlayScreen("Put Down Game Object", Text.GameObjectsChooseList(_gameUniverse.TravelerInventory()), ActionMenu.MainMenu, "");
                ...
                while (!validInventoryObjectId)
                {
                    ...
                    //
                    TravelerObject objectToPutDown = _gameUniverse.TravelerInventory().FirstOrDefault(o => o.Id == travelerObjectId);
        ...
        {
            DisplayGamePlayScreen("Current Inventory", Text.CurrentInventory(_gameUniverse.TravelerInventory()), ActionMenu.MainMenu, "");
        }
